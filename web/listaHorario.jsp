                ...
                <div class="table-responsive">
                    ...
                    <table class="table align-items-center table-flush">
                        <thead class="thead-light">
                            <tr>
                                <th scope="col" class="sort" data-sort="idCliente">ID Horario</th>
                                <th scope="col" class="sort" data-sort="usuario">Horario Apertura</th>
                                <th scope="col" class="sort" data-sort="nombre">Horario Cierre</th>
                                <th scope="col" class="sort" data-sort="edicion">Borrar/Editar</th>
                        ...
                        <tbody class="list">
                            <tr>
                                <%
                                    ...
                                    List<Horario> listaHorarios = controladora.getListaHorarios();
                                ...
                                <td >
                                    ...
                                    <%=hora.getHorarioApertura()%>
                                </td>
                                <td >
                                    <%=hora.getHorarioCierre()%>
                                </td>        
                                       
                                <td >
                                   
                                    <a href="ServletEliminarHorario?id=<%=hora.getIdHorario()%>" class="btn btn-outline-danger" >Borrar</a>
                                    <a href="ServletEditarHorario?id=<%=hora.getIdHorario()%>" class="btn btn-outline-success" >
                                        Editar</a>
                                </td>        
                            </tr>
                            <%}%>
