      ...
      <%    
        ...
        <div class="main-content" id="panel">
            ...
            <div class="container-fluid mt-2 mb-4">
                ...
                <form action="ServletNuevaEntrada" method="POST" class="row g-3">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="Date" name="inputFecha" required class="form-control" id="inputFecha">
                    </div>
                    <div class="col-md-2">
                        <label for="inputHoraEntrada" class="form-label">Hora</label>
                        <input type="text" name="inputHoraEntrada" required class="form-control" id="inputHoraEntrada">
                    </div>
                 
                    <div class="col-md-2">
                        <label for="SelectJuego" class="form-label">Juego</label><br>
                        <select name="selectJuego" class="form-label">
                            <% List<Juego> listaJuegos = controladora.getListaJuegos();
                            for (Juego jueg : listaJuegos) {
                        %>
                        <option value="<%=jueg.getIdJuego()%>"><%=jueg.getNombre()%></option>
                         <% } %>      
                        </select>
                    </div>
                    <div class="col-md-2">
                        <label for="selectCliente" class="form-label">Cliente</label><br>
                        <select name="selectCliente" class="form-label">
                            <% List<Cliente> listaClientes = controladora.getListaClientes();
                    ...
                    <div class="col-md-8">
                        <br>
                        <label for="inputObservacion" class="form-label">Observación</label><br>
                        <textarea name="inputObservacion" maxlength="100"></textarea>
                    </div>    
