       ...
       <!-- Session -->
        ...
        <div class="main-content" id="panel">
            ...
            <div class="container-fluid mt-2 mb-4">
                ...
                <br><br>
                <form action="ServletNuevoUsuario" method="POST" class="row g-3">

                    <div class="col-md-3">
                        <label for="inputUsuario" class="form-label">Usuario</label>
                        <input type="text" name="inputUsuario" class="form-control" id="inputUsuario">
                    </div>
                    <div class="col-md-3">
                        <label for="inputContrasena" class="form-label">Contraseña</label>
                        <input type="password" name="inputContrasena" class="form-control" id="inputContrasena">
                    </div>
