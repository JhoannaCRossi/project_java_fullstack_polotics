                ...
                <div class="table-responsive">
                    ...
                    <table class="table align-items-center table-flush">
                        <thead class="thead-light">
                            <tr>
                                <th scope="col" class="sort" data-sort="idCliente">ID Juego</th>
                                <th scope="col" class="sort" data-sort="nombre">Nombre</th>
                                <th scope="col" class="sort" data-sort="horario">Horario</th>
                        ...
                        <tbody class="list">
                            <tr>
                                ...
                                <td >
                                    <% Horario horario = juego.getUnHorario();
                                        String apertura = horario.getHorarioApertura();
                                        String cierre = horario.getHorarioCierre();
                                ...
                                <td >
                                    <a href="ServletEliminarJuego?id=<%=juego.getIdJuego()%>" class="btn btn-outline-danger" >Borrar</a>
                                    <a href="ServletEditarJuego?id=<%=juego.getIdJuego()%>" class="btn btn-outline-success" >
                                        Editar</a>
                                </td>        
                            </tr>
                            <%}%>
