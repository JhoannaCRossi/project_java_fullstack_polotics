...
%>
                <form action="ServletEditarEmpleado" method="POST" class="row g-3">
                    <div class="col-md-2">
                        <label for="inputId" class="form-label">ID</label>
                        <input type="text" name="inputId" class="form-control" id="inputId" readonly value="<%=emp.getIdEmpleado()%>">
                    </div>

                    <div class="col-md-2">
                        <label for="inputUsuario" class="form-label">Usuario</label>
                        <input type="text" name="inputUsuario" class="form-control" id="inputUsuario" readonly value="<%=emp.getUnUsuario().toString()%>">
                    </div>
                    <div class="col-md-2">
                        <label for="inputDNI" class="form-label">DNI</label>
                        <input type="text" name="inputDNI" class="form-control" id="inputDNI" value="<%=emp.getDni()%>">
                    </div>
                    <div class="col-md-8">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="inputNombre" class="form-control" id="inputNombre" value="<%=emp.getNombre()%>">
                    </div>
                    <div class="col-md-6">
                        <label for="inputApellido" class="form-label">Apellido</label>
                        <input type="text" name="inputApellido" class="form-control" id="inputApellido" value="<%=emp.getApellido()%>">
                    </div>
                    <div class="col-md-6">
                        <label for="inputDirección" class="form-label">Dirección</label>
                        <input type="text" name="inputDireccion" class="form-control" id="inputDirección" value="<%=emp.getDireccion()%>">
                    </div>
                    <div class="col-md-6">
                        <label for="inputTelefono" class="form-label">Teléfono</label>
                        <input type="text" name="inputTelefono" class="form-control" id="inputTelefono" value="<%=emp.getTelefono()%>">
                    </div>
