    ...
    <body>
        ...
        <div class="main-content" id="panel">
            ...
            <div class="container-fluid mt-2 mb-4">
                <h3>Nuevo Horario de Juego</h3>

                <br><br>
                <form action="ServletNuevoHorario" method="POST" class="row g-3">

                    <div class="col-md-3">
                        <label for="inputApertura" class="form-label">Hora de Apertura</label>
                        <input type="text" name="inputApertura" required class="form-control" id="inputApertura">
                    </div>
                    <div class="col-md-3">
                        <label for="inputCierre" class="form-label">Hora de Cierre</label>
                        <input type="text" name="inputCierre" required class="form-control" id="inputCierre">
                    </div>
