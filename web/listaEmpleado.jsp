                ...
                <div class="table-responsive">
                    ...
                    <table class="table align-items-center table-flush">
                        <thead class="thead-light">
                            <tr>
                                <th scope="col" class="sort" data-sort="idCliente">ID Empleado</th>
                                <th scope="col" class="sort" data-sort="idCliente">Usuario</th>
                                ...
                                <th scope="col" class="sort" data-sort="direccion">Dirección</th>
                        ...
                        <tbody class="list">
                            <tr>
                                ...
                                <td >
                                    <% Usuario usuario = empl.getUnUsuario();
                                ...
                                <td >
                                    ...
                                    <a href="ServletEliminarEmpleado?id=<%=empl.getIdEmpleado()%>" class="btn btn-outline-danger" >Borrar</a>
                                    <a href="ServletEditarEmpleado?id=<%=empl.getIdEmpleado()%>" class="btn btn-outline-success" >
                                        Editar</a>
                                </td>        
                            </tr>
                            <%}%>
