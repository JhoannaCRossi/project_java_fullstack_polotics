    ...
    <body>
        ...
        <div class="main-content" id="panel">
            ...
            <div class="container-fluid mt-2 mb-4">
                ...
                <%  Entrada entrada = (Entrada) request.getSession().getAttribute("entradaEditada");
   
%>
                <form action="ServletEditarEntrada" method="POST" class="row g-3">
                    <div class="col-md-2">
                        <label for="inputId" class="form-label">ID</label>
                        <input type="text" name="inputId" class="form-control" id="inputId" readonly value="<%=entrada.getIdEntrada()%>">
                    </div>
                    <div class="col-md-2">
                        <label for="inputFecha" class="form-label">Fecha</label>
                        <input type="text" name="inputFecha" class="form-control" id="inputFecha" readonly value="<%=entrada.getFecha().getYear()+1900%>-<%=entrada.getFecha().getMonth()+1%>-<%=entrada.getFecha().getDay()-1%>">
                    </div>
                    <div class="col-md-1">
                        <label for="inputHora" class="form-label">Hora</label>
                        <input type="text" name="inputHora" class="form-control" id="inputHora" value="<%=entrada.getHora()%>">
                    </div>

                    <div class="col-md-2">
                        <label for="inputCliente" class="form-label">Cliente</label>
                        <input type="text" name="inputCliente" class="form-control" id="inputCliente" value="<%=entrada.getCliente().getIdCliente()%>">
                    </div>
                    <div class="col-md-2">
                        <label for="inputJuego" class="form-label">Juego</label>
                        <input type="text" name="inputJuego" class="form-control" id="inputJuego" readonly value="<%=entrada.getUnJuego().getIdJuego()%>">
                    </div>
                                       
                    <div class="col-md-3">
                        <label for="inputObservacion" class="form-label">Observación</label>
                        <br>
                        <textarea name="inputObservacion" maxlength="100"><%=entrada.getObservacion()%></textarea>
                    </div>
