                ...
                <div class="table-responsive">
                    ...
                    <table class="table align-items-center table-flush">
                        <thead class="thead-light">
                            <tr>
                                <th scope="col" class="sort" data-sort="idCliente">ID Cliente</th>
                        ...
                        <tbody class="list">
                            <tr>
                                ...
                                <td >
                                    ...
                                    <a href="ServletEliminarCliente?id=<%=cli.getIdCliente()%>" class="btn btn-outline-danger" >Borrar</a>
                                    <a href="ServletEditarCliente?id=<%=cli.getIdCliente()%>" class="btn btn-outline-success" >
                                        Editar</a>
                                </td>        
                            </tr>
                            <%}%>
