       ...
       <!-- Session -->
        ...
        <div class="main-content" id="panel">
            ...
            <div class="container-fluid mt-2 mb-4">
                ...
                <br><br>
                <form action="ServletNuevoJuego" method="POST" class="row g-3">
                    ...
                    <div class="col-md-2">
                        <label for="selectHorario" class="form-label">Horarios</label><br>
                        <select name="selectHorario" class="form-label">
                        <%
                        ...
                        %>
                        <option value="<%=hora.getIdHorario()%>"><%=hora.getHorarioApertura()%> a <%=hora.getHorarioCierre()%> </option>
                         <% } %>      
                        </select>
                    </div>   
                    <div class="col-md-2">
                        <label for="selectEmpleado" class="form-label">Empleados</label><br>
                        <select name="selectEmpleado" class="form-label">
                        <%
                            controladora = (Controladora) misession.getAttribute("controladora");
                    ...
                    <div class="col-3 mt-3 text-lg-right">
