...
%>
                <form action="ServletEditarJuego" method="POST" class="row g-3">
                    <div class="col-md-2">
                        <label for="inputId" class="form-label">ID</label>
                        <input type="text" name="inputId" class="form-control" id="inputId" readonly value="<%=juego.getIdJuego()%>">
                    </div>

                    <div class="col-md-2">
                        <label for="inputNombreJuego" class="form-label">Juego</label>
                        <input type="text" name="inputNombreJuego" class="form-control" id="inputNombreJuego"  value="<%=juego.getNombre()%>">
                    </div>
                    <div class="col-md-2">
                        <label for="inputIdHorario" class="form-label">ID Horario</label>
                        <input type="text" name="inputIdHorario" class="form-control" id="inputIdHorario" readonly value="<%=juego.getUnHorario().getIdHorario()%>">
                    </div>
                    <div class="col-md-2">
                        <label for="inputHorarioApertura" class="form-label">Horario Apertura</label>
                        <input type="text" name="inputHorarioApertura" class="form-control" id="inputHorarioApertura" value="<%=juego.getUnHorario().getHorarioApertura()%>">
                    </div>
                    <div class="col-md-2">
                        <label for="inputHorarioCierre" class="form-label">Horario Cierre</label>
                        <input type="text" name="inputHorarioCierre" class="form-control" id="inputHorarioCierre" value="<%=juego.getUnHorario().getHorarioCierre()%>">
                    </div>
                    <div class="col-md-8">
