...
<html>
    ...
    <body class="bg-default" onload="noBack();" onpageshow="if (event.persisted) noBack();">
                        ...
                        <div class="card bg-secondary border-0 mb-0">
                            <div class="card-body px-lg-5 py-lg-5">
                                <div class="alert alert-success d-flex align-items-center" role="alert">
                                    <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Sucess:"><use xlink:href="#exclamation-triangle-fill"/></svg>
                                    <div>
                                      &nbsp; Has salido! Vuelve a ingresar <a href="login.jsp" class="alert-link">Aquí</a>.                       </div>
                                </div>
                            </div>
                        </div>
                    </div>
