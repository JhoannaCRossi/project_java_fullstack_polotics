      ...
      <%    
        ...
        <div class="main-content" id="panel">
            ...
            <div class="container-fluid mt-2 mb-4">
                ...
                <form action="ServletNuevoEmpleado" method="POST" class="row g-3">
                    <div class="col-md-2">
                        <label for="inputDNIemple" class="form-label">DNI</label>
                        <input type="text" name="inputDNIemple" required class="form-control" id="inputDNIemple">
                    </div>
                    <div class="col-md-2">
                        <label for="selectUsuario" class="form-label">Usuarios</label><br>
                        <select name="selectUsuario" class="form-label">
                        <%
                    ...
                    <div class="col-md-6">
                        <label for="inputNombreEmple" class="form-label">Nombre</label>
                        <input type="text" name="inputNombreEmple" required class="form-control" id="inputNombreEmple">
                    </div>
                    <div class="col-md-6">
                        <label for="inputApellidoEmple" class="form-label">Apellido</label>
                        <input type="text" name="inputApellidoEmple" required class="form-control" id="inputApellidoEmple">
                    </div>
                    <div class="col-md-6">
                        <label for="inputDireccionEmple" class="form-label">Dirección</label>
                        <input type="text" name="inputDireccionEmple" required class="form-control" id="inputDireccionEmple">
                    </div>
                    <div class="col-md-6">
                        <label for="inputTelefonoEmple" class="form-label">Teléfono</label>
                        <input type="text" name="inputTelefonoEmple" required class="form-control" id="inputTelefonoEmple">
                    </div>
