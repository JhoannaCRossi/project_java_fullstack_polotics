...
%>
                <form action="ServletEditarHorario" method="POST" class="row g-3">
                    <div class="col-md-2">
                        <label for="inputId" class="form-label">ID</label>
                        <input type="text" name="inputId" class="form-control" id="inputId" readonly value="<%=horario.getIdHorario()%>">
                    </div>

                    <div class="col-md-2">
                        <label for="inputApertura" class="form-label">Horario de Apertura</label>
                        <input type="text" name="inputApertura" class="form-control" id="inputApertura" value="<%=horario.getHorarioApertura()%>">
                    </div>
                    
                    <div class="col-md-2">
                        <label for="inputCierre" class="form-label">Horario de Cierre</label>
                        <input type="text" name="inputCierre" class="form-control" id="inputCierre" value="<%=horario.getHorarioCierre()%>">
                    </div>
