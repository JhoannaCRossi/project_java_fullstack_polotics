                ...
                <div class="table-responsive">
                    ...
                    <table class="table align-items-center table-flush">
                        <thead class="thead-light">
                            <tr>
                                <th scope="col" class="sort" data-sort="idCliente">ID Entrada</th>
                                ...
                                <th scope="col" class="sort" data-sort="nombreJuego">Juego</th>
                                <th scope="col" class="sort" data-sort="nombreCliente">Cliente</th>
                        ...
                        <tbody class="list">
                            <tr>
                                ...
                                <td >
                                    <% Juego juego = ent.getUnJuego();
                                        String nombreJuego = juego.getNombre();
                                    %>
                                    <%=nombreJuego%>
                                </td>
                                <td >
                                    <% Cliente cli = ent.getCliente();
                                        String nombreCliente = cli.getNombre();
                                    %>
                                    <%=nombreCliente%>
                                </td>
                                <td >
                                    <a href="ServletEliminarEntrada?id=<%=ent.getIdEntrada()%>" class="btn btn-outline-danger" >Borrar</a>
                                    <a href="ServletEditarEntrada?id=<%=ent.getIdEntrada()%>" class="btn btn-outline-success" >
                                        Editar</a>
                                </td>        
                            </tr>
                            <%}%>
